...
public class HospitalApplication {
    ...
    public static void main(String[] args){
        ...
        //Create person
        Person per1 = perD.createPerson(1234578678, "Shreya Baliga", util.convertToDate("31-10-1996"));
        Person per2 = perD.createPerson(1234578678, "Neha Baliga", util.convertToDate("20-12-1996"));
